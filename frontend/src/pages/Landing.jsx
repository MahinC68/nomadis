...
// Safe zones: top band (y<18), bottom band (y>82), left edge (x<8), right edge (x>92)
// Avoids: text column (x<45, y 20-80) and globe (x 48-92, y 23-77)
const STARS = [
  // ── top band row 1 (y 2–9) ──────────────────────────────────────────────
  { x:  2, y:  6, s: 1.5, o: 0.40              },
  { x:  7, y:  3, s: 2,   o: 0.50, tw: true   },
  { x: 13, y:  7, s: 1.5, o: 0.30              },
  { x: 19, y:  4, s: 2.5, o: 0.28, spark: true },
  { x: 26, y:  8, s: 1.5, o: 0.40, tw: true   },
  { x: 32, y:  3, s: 2,   o: 0.35              },
  { x: 39, y:  7, s: 1.5, o: 0.30              },
  { x: 46, y:  4, s: 2,   o: 0.45, tw: true   },
  { x: 53, y:  8, s: 1.5, o: 0.35              },
  { x: 59, y:  3, s: 2,   o: 0.40              },
  { x: 65, y:  7, s: 2.5, o: 0.28, spark: true, tw: true },
  { x: 72, y:  5, s: 1.5, o: 0.35              },
  { x: 79, y:  3, s: 2,   o: 0.45              },
  { x: 85, y:  8, s: 1.5, o: 0.30, tw: true   },
  { x: 91, y:  4, s: 2,   o: 0.40              },
  { x: 96, y:  7, s: 1.5, o: 0.50              },
  // ── top band row 2 (y 12–18) ─────────────────────────────────────────────
  { x:  5, y: 14, s: 1.5, o: 0.30              },
  { x: 12, y: 17, s: 2,   o: 0.25, tw: true   },
  { x: 21, y: 13, s: 1.5, o: 0.30              },
  { x: 30, y: 16, s: 2,   o: 0.25              },
  { x: 40, y: 13, s: 1.5, o: 0.30, tw: true   },
  { x: 50, y: 16, s: 2,   o: 0.25              },
  { x: 60, y: 13, s: 1.5, o: 0.30              },
  { x: 70, y: 17, s: 2,   o: 0.25, tw: true   },
  { x: 80, y: 13, s: 1.5, o: 0.30              },
  { x: 89, y: 16, s: 2,   o: 0.25              },
  { x: 97, y: 13, s: 1.5, o: 0.35, tw: true   },
  // ── bottom band row 1 (y 82–88) ─────────────────────────────────────────
  { x:  4, y: 83, s: 1.5, o: 0.30              },
  { x: 11, y: 86, s: 2,   o: 0.25, tw: true   },
  { x: 20, y: 82, s: 1.5, o: 0.30              },
  { x: 29, y: 85, s: 2,   o: 0.25              },
  { x: 38, y: 82, s: 1.5, o: 0.30, tw: true   },
  { x: 48, y: 86, s: 2,   o: 0.25              },
  { x: 57, y: 83, s: 1.5, o: 0.30              },
  { x: 66, y: 85, s: 2,   o: 0.25, tw: true   },
  { x: 75, y: 82, s: 1.5, o: 0.30              },
  { x: 84, y: 86, s: 2,   o: 0.25              },
  { x: 93, y: 83, s: 1.5, o: 0.35, tw: true   },
  // ── bottom band row 2 (y 89–96) ─────────────────────────────────────────
  { x:  8, y: 92, s: 2,   o: 0.40, tw: true   },
  { x: 17, y: 95, s: 1.5, o: 0.30              },
  { x: 27, y: 90, s: 2.5, o: 0.28, spark: true },
  { x: 37, y: 94, s: 1.5, o: 0.35              },
  { x: 47, y: 91, s: 2,   o: 0.30, tw: true   },
  { x: 57, y: 95, s: 1.5, o: 0.40              },
  { x: 67, y: 91, s: 2,   o: 0.30              },
  { x: 76, y: 94, s: 2.5, o: 0.28, spark: true, tw: true },
  { x: 85, y: 90, s: 1.5, o: 0.35              },
  { x: 93, y: 94, s: 2,   o: 0.40, tw: true   },
  { x: 98, y: 90, s: 1.5, o: 0.30              },
  // ── left edge (x 1–7, y 20–80) ──────────────────────────────────────────
  { x:  2, y: 23, s: 1.5, o: 0.35              },
  { x:  5, y: 31, s: 2,   o: 0.28, tw: true   },
  { x:  1, y: 40, s: 1.5, o: 0.30              },
  { x:  4, y: 49, s: 2,   o: 0.35              },
  { x:  2, y: 58, s: 1.5, o: 0.28, tw: true   },
  { x:  6, y: 67, s: 2,   o: 0.32              },
  { x:  1, y: 76, s: 1.5, o: 0.30              },
  // ── right edge (x 93–99, y 20–80) — outside globe ───────────────────────
  { x: 97, y: 22, s: 2,   o: 0.45, tw: true   },
  { x: 95, y: 30, s: 1.5, o: 0.32              },
  { x: 98, y: 39, s: 2,   o: 0.38              },
  { x: 94, y: 48, s: 1.5, o: 0.28, tw: true   },
  { x: 99, y: 57, s: 2,   o: 0.35              },
  { x: 96, y: 66, s: 1.5, o: 0.30              },
  { x: 93, y: 75, s: 2,   o: 0.38, tw: true   },
  { x: 98, y: 80, s: 1.5, o: 0.28              },
]
